...
const DEMO_ACCOUNTS = [
  { role: 'System Admin', email: 'admin@bbms.gh', password: 'Admin@2026', color: 'bg-rose-50 border-rose-200 text-rose-700' },
  { role: 'Blood Bank Officer', email: 'bbo@kob.bbms.gh', password: 'Bbo@2026', color: 'bg-emerald-50 border-emerald-200 text-emerald-700' },
  { role: 'Lab Technician', email: 'lab@kob.bbms.gh', password: 'Lab@2026', color: 'bg-amber-50 border-amber-200 text-amber-700' },
  { role: 'Hospital Admin', email: 'hospadmin@kob.bbms.gh', password: 'Hosp@2026', color: 'bg-violet-50 border-violet-200 text-violet-700' },
  { role: 'Nurse / Doctor', email: 'nurse@kob.bbms.gh', password: 'Nurse@2026', color: 'bg-sky-50 border-sky-200 text-sky-700' },
]
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6">
            <div className="text-xs text-slate-500 mb-3 text-center uppercase tracking-wide">Quick demo access</div>
